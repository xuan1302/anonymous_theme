<?php
 function hello_elementor_breadcrumbs() {
  ...
  if ( !is_home() && !is_front_page() || is_paged() ) {
    ...
    echo '<div class="hello-elementor-breadcrums"><div xmlns:v="http://rdf.data-vocabulary.org/#"  id="crumbs">';

    global $post;
    $homeLink = home_url();
        echo '<span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" class="crumbs-home" href="' . $homeLink . '">' . __( 'Home', 'hello-theme' ) . '</a></span> ' . $delimiter . ' ';
    ...
    elseif ( is_search() ) {
      ...
      echo $before ;
      printf( __( 'Search Results for: %s', 'shtheme' ),  get_search_query() );
      echo  $after;
    ...
    elseif ( is_tag() ) {
      ...
      echo $before ;
      printf( __( 'Tag Archives: %s', 'shtheme' ), single_tag_title( '', false ) );
      echo  $after;
    ...
    if ( get_query_var('paged') ) {
      ...
      echo __('/ page', 'shtheme' ) . ' ' . get_query_var('paged');
      if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo '';
    }
